...
@keyframes slider{
    ...
    30%{
        background-image: url('/image/bbb2.jpg');
    }
    50%{
...
<body>
		...
		<div class="top-nav">
			...
			<div class="right">
				<form class="search-body" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
...
if(isset($_POST['submit'])){
	...
	if($item!=$product_name){
		?>
		<div class="mismatch">Item Not Available</div>
	<?php
	}
...
?>
			...
			<div class="row">
				<div class="left-row">
					<a href="#" class="nav-link" >
						<img class="s11" src="/image/ss1.jpeg" width="100%">
						Buy Now
					</a>
				</div>
				<div class="middle-row">
					<a href="#" class="nav-link" >
						<img class="s11" src="/image/images.jpeg" width="100%">
						Buy Now
					</a>				
				</div>
				<div class="right-row">
					<a href="#" class="nav-link" >
						<img class="s11" src="/image/ss3.jpg" width="100%">
						Buy Now
					</a>
				</div>
			</div>
			 ...
			 while($fetch=mysqli_fetch_array($search)){
				...
				<div class="product">
					<div class="product-1">
						<a href="#" class="nav-link" onclick="openNav()">
							<img src=" <?php echo "admin/product_image/" .$product_image?>" alt="image not available" class="product-image" id="product-style">
							<label class="rs1"><b>  <?php echo "RS " .$product_name ?> </b></label>
							<label class="rs"><b>  <?php echo "RS " .$product_price ."/-"?> </b></label>
						</a>
					</div>
				</div>
		...
		<!-- desktop view  -->
	<div class="desktop">
		<img style="width: 20%;" src="/image/warning-sign-red-png-17.png"><br/>
	...
	<div class="bottom-nav">
		...
		<div class="md">
			...
			<form class="login-form" action="javascript:void(0)">
				...
				<div id="close" style="color:red;cursor:pointer;">
				...
				<div class="md2">
					<img src="/image/images.jpeg" width="65%" height="150px" style="border-radius:5px;margin-left: 40px;margin-top: 10px;">
				</div>

				
				<p style="width:100%;font-size: 14px;text-align: center;"> <b>Big Billion Days Sale Now Starts</b> </p>
